        ...
        <div class="container mx-auto px-6">
            ...
            @else
                <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
                    ...
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-gray-100 flex flex-col h-full">
                        ...
                        <div class="p-6 flex flex-col flex-grow">
                            <h3 class="text-xl font-bold text-gray-800 mb-2 serif">{{ $product->name }}</h3>
                            ...
                            <div class="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                                ...
                                {{-- Tombol Tambah ke Keranjang (Nanti difungsikan) --}}
                                <button class="bg-fuchsia-600 text-white p-2 rounded-lg hover:bg-fuchsia-700 transition shadow-md" title="Tambah ke Keranjang">
